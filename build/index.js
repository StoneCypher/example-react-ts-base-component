...
var hello = function (toWhom) {
    if (toWhom === void 0) { toWhom = 'world'; }
    return "Hello, " + toWhom + "!";
};
...
function P(a,b,e){var d=a.result,c=a.keyPrefix;a=a.func.call(a.context,b,a.count++);Array.isArray(a)?Q(a,d,e,emptyFunction_1.thatReturnsArgument):null!=a&&(E(a)&&(b=c+(!a.key||b&&b.key===a.key?"":(""+a.key).replace(I,"$\x26/")+"/")+e, a={$$typeof:B,type:a.type,key:b,ref:a.ref,props:a.props,_owner:a._owner}), d.push(a));}function Q(a,b,e,d,c){var h="";null!=e&&(h=(""+e).replace(I,"$\x26/")+"/");b=K(b,h,d,c);null==a||M(a,"",P,b);L(b);}var R={Children:{map:function(a,b,e){if(null==a)return a;var d=[];Q(a,d,null,b,e);return d},forEach:function(a,b,e){if(null==a)return a;b=K(null,null,b,e);null==a||M(a,"",O,b);L(b);},count:function(a){return null==a?0:M(a,"",emptyFunction_1.thatReturnsNull,null)},toArray:function(a){var b=[];Q(a,b,null,emptyFunction_1.thatReturnsArgument);return b},only:function(a){E(a)?void 0:q("143");return a}},Component:t,PureComponent:u,unstable_AsyncComponent:x,createElement:D,cloneElement:function(a,b,e){var d=objectAssign({},a.props),c=a.key,h=a.ref,
...
var Spinner = function (_a) {
    var value = _a.value, changeBy = _a.changeBy;
    return react_1("div", null,
        react_1("input", { type: "button", onClick: function () { return changeBy(-1); }, value: "\u2193" }),
        react_1("big", null, value),
        react_1("input", { type: "button", onClick: function () { return changeBy(1); }, value: "\u2191" }));
};
